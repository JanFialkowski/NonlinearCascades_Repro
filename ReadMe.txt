Reproduction code for the paper on nonlinearity of systemic risk

First step: Unzip the data folder, it was too big for github in its raw form
Second step: Set the working directory in the FullPipeline.R file, if necessary
